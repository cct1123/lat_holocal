...
if __name__ == "__main__":
    # x = np.cos(np.linspace(0, 10, 5))
    # value = 0.5
    # result = find_nearest(x, value)
    # print(x-value)
    # print(result)
    ...
    x_panm_m2 = np.array([[-3710.42775556, -3510.82283023, -3293.5278642,  -3058.23182206],
    [-1221.97387753, -1156.1846893,  -1086.10553849, -1010.61253516],
    [1221.97387753,  1156.1846893,   1086.10553849,  1010.61253516],
    [3710.42775556 , 3510.82283023  ,3293.5278642 ,  3058.23182206]])
    y_panm_m2 = np.array([[-3860.78430822, -1189.16187393  ,1115.56121063 , 3182.15963424],
    [-3770.29875755, -1161.23885912 , 1090.85336284  ,3118.16091631],
    [-3770.29875755, -1161.23885912 , 1090.85336284  ,3118.16091631],
    [-3860.78430822, -1189.16187393 , 1115.56121063, 3182.15963424]])
